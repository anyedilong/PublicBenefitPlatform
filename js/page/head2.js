...
document.writeln("            </div>");
document.writeln("        </div>");
document.writeln("<div class=\'rz_bg\'>");
document.writeln("<div class=\'body-container\'>");
document.writeln("<div class=\'layui-row\'>");
document.writeln("        <div class=\'layui-col-md5 rz_top\'>");
document.writeln("            <div class=\'myFlex\'>");
document.writeln("                <img src=\'../img/photo.png\' alt=\'\' class=\'rz_tx\'>");
document.writeln("                <div class=\'rz_xx\'>");
document.writeln("                    <p id='top_uname'>未登录</p>");
document.writeln("                    <div>");
document.writeln("                        <span><img src=\'../img/img_set_rz.png\' alt=\'\'> 实名认证</span>");
document.writeln("                        <span style=\'margin-left: 30px;\'><img src=\'../img/img_set_rz.png\' alt=\'\'> 手机号绑定</span>");
document.writeln("                    </div>");
document.writeln("                </div>");
document.writeln("            </div>");
document.writeln("        </div>");
document.writeln("        <div class=\'layui-col-md-offset2 layui-col-md4 rz_top\'>");
document.writeln("            <button type=\'button\' class=\'layui-btn layui-btn-radius bg_lightgreen\' style=\'width: 150px;\'>实名认证</button>");
document.writeln("        </div>");
document.writeln("    </div>");
document.writeln("    </div>");
document.writeln("    </div>");
